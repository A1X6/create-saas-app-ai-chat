...
export const metadata: Metadata = {
  ...
  description: 'Learn how {{APP_NAME}} collects, uses, and protects your personal information. We prioritize your privacy and data security. Read our comprehensive privacy policy.',
  keywords: [
    'privacy policy',
    'data protection',
    'user privacy',
